        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 animate-backdrop">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm animate-modal-enter">
            <div className="flex justify-between items-center mb-3">
              ...
              <button onClick={() => setDeleteTarget(null)} aria-label="关闭删除确认弹窗" className="text-neutral-400 hover:text-neutral-600 p-3 rounded hover:bg-neutral-100 transition-colors">
                <X className="w-5 h-5" />
              </button>
            </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 animate-backdrop">
      ...
      <div className="bg-white rounded-2xl w-full max-w-md p-5 shadow-lg animate-modal-enter">
        <div className="flex items-center justify-between mb-5">
          ...
          <button onClick={onClose} aria-label="关闭配置编辑弹窗" className="text-neutral-400 hover:text-neutral-600 p-3 rounded hover:bg-neutral-100 transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
