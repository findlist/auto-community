  ...
  return (
    ...
    <div className="px-4 py-4 pb-20 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-4">
        <button onClick={() => navigate(-1)} aria-label="返回" className="text-neutral-500 hover:text-neutral-700 p-3 -ml-2 rounded hover:bg-neutral-100 transition-colors">
      ...
      {error && (
        <div className="flex items-center gap-2 p-3 mb-4 bg-red-50 text-red-600 rounded-lg text-sm">
          ...
          <button
            ...
            className="ml-auto text-xs px-3 py-2 rounded-lg hover:bg-red-100 transition-colors"
          >
            重试
          </button>
        </div>
