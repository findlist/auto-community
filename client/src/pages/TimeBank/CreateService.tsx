  ...
  return (
    ...
    <div className="px-4 py-4 pb-20 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <button onClick={() => navigate(-1)} className="text-neutral-500 hover:text-neutral-700 transition-colors">
          <ArrowLeft className="w-5 h-5" />
        </button>
        <h1 className="text-lg font-semibold text-neutral-900">发布服务</h1>
      </div>
      ...
      <div className="bg-white rounded-lg p-4 shadow-sm space-y-4">
        ...
        <div>
          ...
          <input
            ...
            // 焦点环改用时间银行模块紫 15% 透明度光晕 + 400 阶边框，与列表页 Tab/发布按钮的紫色语言一致
            className={`w-full px-3 py-2.5 bg-neutral-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/15 focus:border-violet-400 transition-all ${getFieldError("category") ? "border-red-500" : "border-neutral-200"}`}
          />
        ...
        <div>
          ...
          <input
            ...
            placeholder="请输入服务标题"
            className={`w-full px-3 py-2.5 bg-neutral-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/15 focus:border-violet-400 transition-all ${getFieldError("title") ? "border-red-500" : "border-neutral-200"}`}
          />
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className={`w-full px-3 py-2.5 bg-neutral-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/15 focus:border-violet-400 transition-all resize-none ${getFieldError("description") ? "border-red-500" : "border-neutral-200"}`}
          />
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="60"
              min="1"
              className={`w-full pl-9 pr-3 py-2.5 bg-neutral-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/15 focus:border-violet-400 transition-all ${getFieldError("durationMinutes") ? "border-red-500" : "border-neutral-200"}`}
            />
          </div>
      ...
      <button
        ...
        disabled={submitting}
        // 提交按钮使用时间银行模块紫，与 TimeAccount 转赠/捐赠按钮 bg-violet-600 一致
        className="w-full mt-6 py-3 bg-violet-600 text-white rounded-lg font-medium hover:bg-violet-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
      >
