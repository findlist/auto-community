...
]), asyncHandler(async (req: Request<{}, any, UpdateProfileBody>, res: Response) => {
...
]), asyncHandler(async (req: Request<{}, any, VerifyBody>, res: Response) => {
...
]), asyncHandler(async (req: Request<{}, any, DeletionRequestBody>, res: Response) => {
