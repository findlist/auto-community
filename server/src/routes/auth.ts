...
]), asyncHandler(async (req: Request<{}, any, RegisterBody>, res: Response) => {
...
]), asyncHandler(async (req: Request<{}, any, LoginBody>, res: Response) => {
...
]), asyncHandler(async (req: Request<{}, any, RefreshTokenBody>, res: Response) => {
...
router.post('/forgot-password', authLimiter, validate([
  body('phone').matches(/^1[3-9]\d{9}$/).withMessage('手机号格式不正确')
]), asyncHandler(async (req: Request<{}, any, ForgotPasswordBody>, res: Response) => {
...
router.post('/reset-password', authLimiter, validate([
  ...
  body('password').isLength({ min: 6 }).withMessage('密码至少6位')
]), asyncHandler(async (req: Request<{}, any, ResetPasswordBody>, res: Response) => {
...
router.post('/simple-reset-password', authLimiter, validate([
  body('phone').matches(/^1[3-9]\d{9}$/).withMessage('手机号格式不正确'),
  body('password').isLength({ min: 6 }).withMessage('密码至少6位')
]), asyncHandler(async (req: Request<{}, any, SimpleResetPasswordBody>, res: Response) => {
  const { phone, password } = req.body;
